        ...
        <div class="uk-grid-24" uk-grid>
            ...
            <div class="uk-width-1-4@l">
                ...
                <div class="item-20px home__boxThongke padding-12">
                    ...
                    <div class="item-10px text-555 barlow-medium">
                        <div class="uk-grid-10 uk-flex-middle" uk-grid>
                            <div class="uk-width-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M9 13C9.66 13 10.5001 13.1003 11.3701 13.2803C9.33014 14.4103 9 15.9 9 16.75V19H3C2.45 19 2 18.55 2 18V16.5C2 14.17 6.67 13 9 13ZM16.5 14C18.33 14 22 14.92 22 16.75V18C22 18.55 21.55 19 21 19H12C11.45 19 11 18.55 11 18V16.75C11 14.92 14.67 14 16.5 14ZM16.5 7C17.88 7 18.9902 8.12 18.9902 9.5C18.9902 10.88 17.88 12 16.5 12C15.12 12 14 10.88 14 9.5C14 8.12 15.12 7 16.5 7ZM9 5C10.66 5 11.9902 6.34 11.9902 8C11.9902 9.66 10.66 11 9 11C7.34 11 6 9.66 6 8C6 6.34 7.34 5 9 5Z" fill="black" fill-opacity="0.54"/>
                                </svg>
                            </div>
                            <div class="uk-width-expand">
                                Đang trực tuyến:
                    ...
                    <div class="item-10px text-555 barlow-medium">
                        <div class="uk-grid-10 uk-flex-middle" uk-grid>
                            <div class="uk-width-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M19 3C20.1 3 21 3.9 21 5V19C21 20.1 20.1 21 19 21H5C3.9 21 3 20.1 3 19V5C3 3.9 3.9 3 5 3H19ZM8 10C7.45 10 7 10.45 7 11V16C7 16.55 7.45 17 8 17C8.55 17 9 16.55 9 16V11C9 10.45 8.55 10 8 10ZM12 7C11.45 7 11 7.45 11 8V16C11 16.55 11.45 17 12 17C12.55 17 13 16.55 13 16V8C13 7.45 12.55 7 12 7ZM16 13C15.45 13 15 13.45 15 14V16C15 16.55 15.45 17 16 17C16.55 17 17 16.55 17 16V14C17 13.45 16.55 13 16 13Z" fill="black" fill-opacity="0.54"/>
                                </svg>
                            </div>
                            <div class="uk-width-expand">
                                Tổng lượt truy cập:
